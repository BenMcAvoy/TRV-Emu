...
int main(void) {
    ...
    */
    ...
    while (!glfwWindowShouldClose(window) && !globals::shouldExit) {
        ...
        ImGui::Text("Zero  : %08X", cpu->zero);
        ImGui::Text("RA    : %08X", cpu->ra);
        ImGui::Text("SP    : %08X", cpu->sp);
        ImGui::Text("GP    : %08X", cpu->gp);
        ImGui::Text("TP    : %08X", cpu->tp);
        ImGui::Text("RA    : %08X", cpu->ra);
        ImGui::Text("T0    : %08X", cpu->t0);
        ImGui::Text("T1    : %08X", cpu->t1);
        ImGui::Text("T2    : %08X", cpu->t2);
        ImGui::Text("S0/FP : %08X", cpu->s0);
        ImGui::Text("A0    : %08X", cpu->a0);
        ImGui::Text("A1    : %08X", cpu->a1);
        ImGui::Text("A2    : %08X", cpu->a2);
        ImGui::Text("A3    : %08X", cpu->a3);
        ImGui::Text("A4    : %08X", cpu->a4);
        ImGui::Text("A5    : %08X", cpu->a5);
        ImGui::Text("A6    : %08X", cpu->a6);
        ImGui::Text("A7    : %08X", cpu->a7);
        ImGui::Text("S1    : %08X", cpu->s1);
        ImGui::Text("S2    : %08X", cpu->s2);
        ImGui::Text("S3    : %08X", cpu->s3);
        ImGui::Text("S4    : %08X", cpu->s4);
        ImGui::Text("S5    : %08X", cpu->s5);
        ImGui::Text("S6    : %08X", cpu->s6);
        ImGui::Text("S7    : %08X", cpu->s7);
        ImGui::Text("S8    : %08X", cpu->s8);
        ImGui::Text("S9    : %08X", cpu->s9);
        ImGui::Text("S10   : %08X", cpu->s10);
        ImGui::Text("S11   : %08X", cpu->s11);
        ImGui::Text("T3    : %08X", cpu->t3);
        ImGui::Text("T4    : %08X", cpu->t4);
        ImGui::Text("T5    : %08X", cpu->t5);
        ImGui::Text("T6    : %08X", cpu->t6);
